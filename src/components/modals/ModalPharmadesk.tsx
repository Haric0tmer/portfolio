				...
				<div className='relative w-auto my-6 mx-auto max-w-3xl'>
					...
					<div className='border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-slate-700 outline-none focus:outline-none max-h-screen'>
						...
						<div className='relative p-6 flex-auto overflow-y-auto max-h-[calc(100vh-200px)]'>
							...
							<p className='text-xl text-white font-light mt-5 text-justify'>
								{locale === "fr"
									? "Pour faire ce projet j'ai eu un total de 4 semaines pour prendre en compte tous les aspects du développement d'une application de la conception à la mise en production. Au cours de ce projet j'ai eu l'occasion d'utilisé toutes lesconnaissances acquises durant mon stage afin de produire une application du même niveau dans un laps de temps trois fois plus court."
