      ...
      return(
         ...
         <div className="laptop:w-2/5">
            <h1 className="text-white text-4xl laptop:text-7xl font-semibold">
               {locale === 'fr' ? "Bonjour, je suis Laurent Boualavong" : "Hello, I am Laurent Boualavong"}
            </h1>
            <p className="mt-4 text-white text-lg">
               {locale === 'fr' ? "Développeur - Alternant en 1ère année à l'IMT Mines d'Alès." : "Developer - Work-study student in 1st year at IMT Mines d\'Alès engineering school."}
            </p>
         </div>
         ...
         <div className="laptop:w-2/5">
            ...
            <p className="md:text-lg text-md text-white font-light mt-5 laptop:text-justify">
               {locale === 'fr' ? "Bonjour, je suis Laurent Boualavong, actuellement en 1ère année aux Mines d'Alès dans la filière informatique et réseaux, parcours développement logiciel en alternance. Principalement intéressé par le développement web et logiciel, j'aime pouvoir utiliser mes capacités afin de trouver des solutions aux problèmes des utilisateurs. De nature curieux, j'adore acquérir de nouvelles connaissances sur divers sujets." 
               :
